...
distclean() {
    ...
    cd ../log4cxx
    rm -rf apache-log4cxx-0.10.0 include lib apache-log4cxx-0.10.0.0voice

    cd ../test
    make clean

    cd ../test_db_proxy
    rm -rf Makefile CMakeCache.txt CMakeFiles cmake_install.cmake db_proxy_server log
    ...
    rm -rf Makefile CMakeCache.txt CMakeFiles cmake_install.cmake etcd_login_server
